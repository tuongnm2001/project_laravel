            ...
            <div class="block2">
                ...
                <div class="block2-txt flex-w flex-t p-t-14">
                    <div class="block2-txt-child1 flex-col-l ">
                        <a href="/san-pham/{{ $item->id }}-{{ \Str::slug($item->name,'-') }}.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                            Esprit Ruffle Shirt
                        </a>

                        <span class="stext-105 cl3">
                            {!! \App\Helpers\Helper::price($item->price , $product->price_save) !!}
                        </span>
                    </div>
